...
const blogPosts = [
    {
        ...
        date: "Dec 10, 2025",
        title:
            "This Portfolio was made with React JS and others techologies",
...
const techStack = [
    ...
    {
        category: "Mobile",
        items: ["React Native", "Expo", "Kotlin", "Java", "Flutter"],
    },
    {
        category: "Styling",
    ...
    {
        category: "Dev Tools",
        items: ["Git", "GitHub", "Android Studio", "IntelliJ IDEA"],
    },
];
            ...
            children: [
                {
                    ...
                    description: [
                        "My Trucker Diary is a robust digital assistant for truck drivers, enabling complete work journey management, including mileage, cargo, and rest times.",
                        "Features: Trip Management (Detailed Records, Mileage Control), Driver Dashboard (Real-time Status, Journey Counters), PDF Reports, and Community Feed.",
                        "Tech Stack: Kotlin, Jetpack Compose (Material 3), MVVM, Koin, Firebase (Firestore, Auth, Storage), Google Play Services, and Jetpack DataStore.",
                    ],
                },
                {
                    id: 2,
                    name: "mytruckdiary.com",
                    icon: "/images/safari.png",
                    kind: "file",
                    fileType: "url",
                    href: "https://mytruckdiary.com",
